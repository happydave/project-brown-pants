...
- `cargo run -p sounding -- play` — fly a craft by hand (WI 535): Shift/Ctrl throttle · Z/X full/cut · WSAD/QE attitude · T hold / R kill-rot / F SAS off · `,`/`.` warp; full flight HUD with Δv, apoapsis/periapsis, and specific energy
