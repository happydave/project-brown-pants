...
- `cargo run -p sounding -- play` — a continuous one-craft session (first-playable shell): Launch → Flight → Recovery (a sounding), the HUD showing the phase, on the unified flight pipeline (WI 534)
