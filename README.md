...
- `cargo run -p sounding -- dive` — the Toy 9 dive: a craft falls vacuum→atmosphere→ocean, drag/buoyancy/pressure all from one fluid field (HUD shows altitude/speed/medium)
